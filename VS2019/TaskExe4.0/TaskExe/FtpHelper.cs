...
namespace  TaskExe
{
    public class FtpHelper
    {
        ...
        //获取FTP上面的文件夹和文件
        public static string[] GetFolderAndFileList()
        {
    ...
    public class AsmlFtpWeb
    {
...

        {
...

            {
                 ...
                 Console.WriteLine("FtpWeb", "Upload Error --> " + ex.Message);
...

        {
...

            {
                ...
                reqFTP = (FtpWebRequest)FtpWebRequest.Create(new Uri(ftpURI + fileName));
                 ...
                 Console.WriteLine(ftpURI + fileName);
            ...
            {
                 Console.WriteLine(ex.Message);
                 Console.WriteLine("FtpWeb", "Download Error --> " + ex.Message);
...

        {
...

            {
                ...
                //   Console.WriteLine("FtpWeb", "Delete Error --> " + ex.Message + "  文件名:" + fileName);
...

        {
...

            {
                 ...
                 Console.WriteLine("FtpWeb", "Delete Error --> " + ex.Message + "  文件名:" + folderName);
...

        {
...

            {
...

                {
                     ...
                     Console.WriteLine("FtpWeb", "GetFileList Error --> " + ex.Message.ToString());

...
if __name__ == "__main__":
    pass
    print("输入‘AWE’，刷新AWE数据")
    print("输入‘BatchReport’，刷新BatchReport数据")
    print("输入‘Nikon’，刷新Nikon EGA Log数据")
    print("输入‘All’，刷新以上所有数据")
    print("输入‘Metal’，查看最新产品Metal层次TopDown照片")

    choice=input("请输入选项: ")
    if choice.upper().strip()=="AWE":
        print("===AWE===")
        AWE_ANALYSIS_NEW_TAR().MainFunction()
    elif choice.upper().strip()=="BATCHREPORT":
        print("===BatchReport===")
        AsmlBatchReport_TAR().MainFunction()
    elif choice.upper().strip()=="NIKON":
        print("===Nikon===")
        NikonVector_NEW().MainFunction()
    elif choice.upper().strip()=="ALL":
        print("===ALL===")
        try:
            AWE_ANALYSIS_NEW_TAR().MainFunction()
        except:
        ...
        try:
            ...
            pass
    elif choice.upper().strip()=="METAL":
        NikonProductMetalImage().MainFunction()

    else:
        input("No Action,Press Any Key To Exit")

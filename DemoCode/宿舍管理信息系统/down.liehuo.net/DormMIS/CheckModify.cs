...
namespace DormMIS
{
	...
	/// CheckModify 的摘要说明。
	/// </summary>
	public class CheckModify : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.btSure.Location = new System.Drawing.Point(48, 220);
			...
			this.btClose.Location = new System.Drawing.Point(232, 220);
		...
		private void btSure_Click(object sender, System.EventArgs e)
		{
			if (textDormID.Text.Trim()=="")
				MessageBox.Show("填写宿舍号","提示");
			else
			{
				oleConnection1.Open();
				string sql="update checkinfo set dormID='"+textDormID.Text.Trim()+"',CDate='"+date1.Text.Trim()+"',CState='"+comboState.Text.Trim()+"',"+
					"CRemark='"+textRemark.Text.Trim()+"' where CheckID="+this.Tag.ToString().Trim()+"";

...
namespace DormMIS
{
	...
	/// Repair 的摘要说明。
	/// </summary>
	public class Repair : System.Windows.Forms.Form
	{
		...
		private void btQuery_Click(object sender, System.EventArgs e)
		{
			oleConnection1.Open();
			ds = new DataSet();
			string sql="select dormID as 宿舍号,person as 报修人,repair as 报修情况,DateIn as 报修日期,DateRepair as 修理日期,RepairID as 修理编号 from repair";
		...
		private void btDel_Click(object sender, System.EventArgs e)
		{
			...
			{
				oleConnection1.Open();
				string sql = "delete * from repair where RepairID="+ds.Tables[0].Rows[dataGrid1.CurrentCell.RowNumber][5]+"";

...
namespace DormMIS
{
	...
	/// Charge 的摘要说明。
	/// </summary>
	public class Charge : System.Windows.Forms.Form
	{
		...
		private void btQuery_Click(object sender, System.EventArgs e)
		{
			oleConnection1.Open();
			ds = new DataSet();
			string sql="select dormID as 宿舍号,MDate as 缴费日期,EBuy as 购买电量,CPerson as 购买人,CMoney as 电费,ChargeID as 编号 from charge";
		...
		private void btDel_Click(object sender, System.EventArgs e)
		{
			...
			{
				oleConnection1.Open();
				string sql = "delete * from charge where ChargeID="+ds.Tables[0].Rows[dataGrid1.CurrentCell.RowNumber][5]+"";

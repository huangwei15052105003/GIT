...
namespace sgClass
{
    public class DbHelperOleDb
    {
        ...
        public static string connectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source="+AppDomain.CurrentDomain.BaseDirectory + @"CheckDB.mdb";
        ...
        public static DataSet QueryPage(int pageIndex, int pageSize, string SQLString, params OleDbParameter[] cmdParms)
        {
            ...
            //OleDbDataAdapter dataAdapter = new OleDbDataAdapter(ocmd);

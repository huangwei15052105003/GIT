...
namespace star.IN
{
	public class IN030 : star.Public.BaseDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.dateTimePicker2.Location = new System.Drawing.Point(1, 1);
			...
			this.ckDa.Name = "ckDa";
			this.ckDa.Size = new System.Drawing.Size(14, 23);
		...
		protected override void clickOk(object sender, EventArgs e)
		{
			...
			if(this.ckDa.Checked)
			{
				...
				s=s+ "  C_DATE<=#"+this.dateTimePicker2.Text+"#";
			}
			...
			try
			{
				...
				//r.Load (this.repName);
				star.RP.IN030 r=new star.RP.IN030 ();
